...
This repository contains the public product, privacy, support, and localized introduction pages for Motune.
...
- `zh-Hans.md` - Simplified Chinese localized detail page.
- `zh-Hant.md` - Traditional Chinese localized detail page.
- `ja.md` - Japanese localized detail page.
- `ko.md` - Korean localized detail page.
- `es.md` - Spanish localized detail page.
...
The main page is organized around real user pain points:

- Earbud taps are easy to miss while running.
...
- Product URL: repository GitHub Pages root URL
